...
> **Changements v2 :** Intégration du système de bonus numériques (+0 à +3), états de dégradation (Neuf/Endommagé/Détruit), ajout des armes de mêlée, clarification des interactions bonus/accessoires/dégradation. Toutes les armes à feu de la v1 sont conservées telles quelles.
>
...
**Le bonus ne se cumule PAS avec les accessoires qui donnent un bonus au Score** (ex: Crosse tactique +1). Si tu as un fusil +2 avec une Crosse tactique +1, le Score d'attaque gagne +2 (pas +3). On prend le **plus élevé** entre le bonus de l'arme et le bonus de l'accessoire, pas la somme.

> **Pourquoi ?** Pour éviter l'inflation. Le plafond de loot est +3 — si les accessoires se cumulent avec le bonus d'arme, un PJ pourrait atteindre +5 ou +6 et trivialiser le jeu. Le bonus d'arme **remplace** le bonus d'accessoire au Score.

### Interaction bonus d'arme et accessoires

| Accessoire | Se cumule avec le bonus d'arme ? |
|---|---|
...
| **Munitions perforantes** (Perforant +1) | **Oui.** Perforant affecte l'Armure, pas le Score. |
...
> Les tables ci-dessous sont identiques à la v1 pour les armes à feu. Les colonnes Prix et PM restent inchangées.

### PISTOLETS (1 main)

| Nom | TL | Dégâts | Auto | Portée | Prix | PM | Propriétés |
|---|---|---|---|---|---|---|---|
...
| Nom | TL | Dégâts | Reach | Prix | PM | Propriétés |
|---|---|---|---|---|---|---|
...
Chaque arme a un nombre de **Points de Modification (PM)** qui détermine combien de modifications elle peut recevoir. Installer un accessoire coûte **1 action hors combat + jet d'Ingénierie (difficulté 2)**.
...
| Accessoire | PM requis | Prix | Effet |
|---|---|---|---|
...
TL 1 | 1d8 / Auto 1d10 | Portée 30 | PM: 2
Propriétés: Tir Auto
Accessoires: —
...
TL 2 | 1d10 / Auto 1d12 | Portée 30 | PM: 3
Propriétés: Tir Auto, Silencieux
Accessoires: Lunette (portée longue sans Désavantage)
...
TL 3 | 2d6 / Auto 2d8 | Portée 30 | PM: 3
Propriétés: Tir Auto, Magnétique
Accessoires: Bipied
...
TL 4 | 2d10 | Portée 80 | PM: 3
Propriétés: Magnétique, Précis 2, Perforant 3, Encombrant 2
Accessoires: —
...
TL 2 | 1d6 | Reach 1 | PM: 1
Propriétés: Finesse, Perforant 2
Accessoires: —
...
- Perforant (arme) + Perforant (munitions perforantes accessoire) → Perforant total
- Précis (arme) + action Viser (Avantage) → les deux s'appliquent
...
| Perforant total | Pas de plafond (mais l'Armure la plus haute du jeu est ~12) |
| Points de Modification par arme | Défini par l'arme (0-3) |

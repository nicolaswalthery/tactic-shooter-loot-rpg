...
| 9 | **Fumigènes (×4).** Lot de quatre fumigènes screening. | Consommable | ◻ | — | Zone opaque de rayon 3, 1d4 rounds. Bloque la ligne de vue. | 0 |
| 10 | **Armure de combat modulaire.** Plaques interchangeables, bien entretenue. | Armure (M) | ◻ | +0 | Armure 7. Modulaire (+1 PM). | 2 |
...
| 13 | **Lunette ACOG améliorée.** Optique de précision, reticule holographique. | Accessoire | 🔷 | **+1** | S'installe sur un fusil (1 PM). Le bonus s'ajoute au Score de Tir de l'arme. | 2 |
...
| 12 | **Stim pack "Vanguard" (×3).** Stimulants militaires améliorés. | Consommable | 🔷 | — | Active 1 Surge + supprime Secoué (même Secoué 3). | 2 |
...
| 15 | **Injecteur "Phoenix".** Ramène un Mourant à la conscience. | Consommable | 🔷 | — | Mourant → 1 PV + Secoué 2. Sans Médecine. Usage unique. | 2 |
...
| 4 | **Lame d'os vitreux.** Tranchant moléculaire naturel. | Arme | ◻ | +0 | 1d6. Reach 1. Finesse. Perforant 1. | ? |
...
| 15 | **Lame de phase.** Existe partiellement dans une autre dimension. | Arme | 🔷 | **+1** | 1d8. Reach 1. Finesse. Perforant 2. | ? |
...
| 19 | **Canon à singularité "Collapse".** Micro-trous noirs. | Arme | 🔶 | **+2** | 2d8. Portée 15. Zone 1. Ignore Armure. Attire cibles de 2 cases. | ? |
...
| 6 | **Blindage de portière (×2).** Plaques d'acier à boulonner. | Accessoire | ◻ | +0 | +2 Armure véhicule. Installation 1 Stretch + Ingénierie. | 1 |
| 7 | **Turbo-compresseur.** Boosteur mécanique, installation simple. | Accessoire | ◻ | +0 | +2 Speed véhicule. 1 PM véhicule. | 2 |
| 8 | **Phares anti-émeute.** Projecteurs stroboscopiques. | Accessoire | 🔷 | — | Cône 6 cases : save WIT ou Aveuglé 1 round. 3 charges/Shift. 1 PM. | 2 |
| 9 | **Mitrailleuse montée "Rampart".** Tourelle légère. | Arme (véhicule) | 🔷 | **+1** | 2d6, Auto 2d8. Portée 20. Arc 180°. 1 PM. | 2 |
| 10 | **Blindage composite.** Plaques céramique-acier professionnelles. | Accessoire | 🔷 | **+1** | +3 Armure véhicule. 2 PM. | 2 |
| 11 | **Moto "Hornet".** Deux roues léger, rapide, silencieux. | Véhicule | 🔷 | — | Speed 16. Armure 2. PV 15. 1 passager. Discret. 1 PM. | 2 |
| 12 | **4×4 blindé "Warthog".** Tout-terrain militarisé. | Véhicule | 🔷 | — | Speed 10. Armure 8. PV 30. 4 passagers. 2 PM. | 2 |
...
| 14 | **Système ECM véhiculaire.** Contre-mesures électroniques. | Gadget | 🔷 | — | Désavantage sur attaques guidées/missiles ciblant le véhicule. 1 PM. | 3 |
| 15 | **Moteur hybride "Spectre".** Propulsion silencieuse + boost. | Accessoire | 🔷 | **+1** | +4 Speed + mode silencieux (Avantage Discrétion). 2 PM. | 3 |
| 16 | **Tourelle auto "Sentry".** Arme autonome montée. | Arme (véhicule) | 🔷 | **+1** | 1d10. Portée 15. IA Score 9 (pas besoin d'opérateur). 2 PM. | 3 |
| 17 | **Navette "Kestrel".** Petit transport aérien, ailes repliables. | Véhicule | 🔷 | — | Speed 20 (vol). Armure 5. PV 25. 6 passagers. 3 PM. Portée planétaire. | 3 |
| 18 | **APC "Rhino".** Transport de troupes blindé lourd. | Véhicule | 🔶 | — | Speed 8. Armure 12. PV 50. 8 passagers. Tourelle 2d8. 4 PM. | 3 |
| 19 | **Intercepteur "Barracuda".** Vaisseau monoplace de combat. | Véhicule | 🔶 | — | Speed 25 (espace). Armure 8. PV 30. Canons 2d10. 3 PM. | 4 |
| 20 | **Corvette "Stormbreaker".** Vaisseau multi-rôle. | Véhicule | 🔶 | — | Speed 18 (espace). Armure 14. PV 60. 12 passagers. Tourelle 3d8 + missiles 4d10. 5 PM. | 4 |
...
| 3 | **Munitions perforantes (×20).** Sous-calibrées, illégales. | Consommable | ◻ | — | Perforant 1 pendant 1 combat (1 arme). Puis épuisées. | 2 |
...
| 15 | **Pistolet "Keelhauler".** Arme de contrebandier légendaire. | Arme | 🔷 | **+2** | 1d8. Portée 10. Dissimulable. 1 PM libre. | 2 |
...
| 19 | **Lame monofilament "Razorwire".** Un seul atome d'épaisseur. | Arme | 🔶 | **+2** | 1d10. Reach 1. Finesse. Perforant 3. Fragile. | 4 |
